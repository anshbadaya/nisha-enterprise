...
gulp.task("html:build", function () {
  return gulp
    ...
    .pipe(
      comments(`
    WEBSITE: https://Nisha Enterprise.com
    TWITTER: https://twitter.com/Nisha Enterprise
    FACEBOOK: https://www.facebook.com/Nisha Enterprise
    GITHUB: https://github.com/Nisha Enterprise/
    `)
    )
